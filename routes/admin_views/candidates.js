const list = async (request, response) => {
    ...
    response.render(__dirname + '/../public/Jobhunt/admin_views/candidates.ejs', {
...
const form_render = async (request, response) => {
    /* if id in url params, render update form else render create form */
    response.render(__dirname + '/../public/Jobhunt/admin_views/candidates_form.ejs', {
        data: {...responsetoclient},
        request: request,
        response: response
    })
...
const form_api = async (request, response, ) => {
